...
export default function Donation()
{
    ...
    return(
        <div>
            <iframe style={{"width" : "100vw", "height":"100vh", "textAlign":"center", "alignItems": "center"}} src="https://docs.google.com/document/d/e/2PACX-1vTWOJi-PsAUdPXG1T46XyaU0JpIjw2sYysZS6xHek4-P6a1phV6O0xLfyCyOdUNMjkXLgv5jKzlojUa/pub?embedded=true"></iframe>
        </div>
    );
}